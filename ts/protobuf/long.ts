...
* @inner
*/
let TWO_PWR_63_DBL = TWO_PWR_64_DBL / 2;
...
export class Long{
     ...
     * @inner
     */
    static fromInt(value?:any, unsigned?:any) {
     ...
     * @inner
     */
    static fromBits(lowBits?:any, highBits?:any, unsigned?:any) {
     ...
     * @inner
     */
    static fromString(str?:any, unsigned?:any, radix?:any): Long {
        if (str.length === 0)
        ...
        let radixToPower = Long.fromNumber(pow_dbl(radix, 8));
        ...
        for (let i = 0; i < str.length; i += 8) {
            ...
            if (size < 8) {
                let power = Long.fromNumber(pow_dbl(radix, size));
